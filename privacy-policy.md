...
- __Application__ means the software program provided by the Company downloaded by You on any electronic device, named preppa


- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to preppa.
...
- __Website__ refers to preppa, accessible from [preppa.no](preppa.no)
...
- By email: sondrelvigerust@gmail.com
